        ...
        <MDBContainer fluid>
          ...
          <MDBCollapse open={openNavColorSecond} navbar id='navbarColor02'>
            <MDBNavbarNav className='me-auto mb-2 mb-lg-0'>
              ...
              <MDBNavbarLink style={{color:'black',fontSize:'18px'}} href='/alluser/order'>All Orders</MDBNavbarLink>
              </MDBNavbarItem>
              <MDBNavbarItem className='mx-lg-4 px-lg-4'>
                
                <MDBNavbarLink style={{color:'black',fontSize:'18px'}} href='/allusers'>All Users</MDBNavbarLink>
              </MDBNavbarItem>
              <MDBNavbarItem className='mx-lg-4 px-lg-4'>
